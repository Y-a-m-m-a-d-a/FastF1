...
from config import (BANNER, BOLD, RED, CYAN, GREEN, YELLOW, RESET,
                    open_figures, close_all)
from session import pick_session
from plots import (speed_tracks, position_changes, gear_shifts,
                   qualifying_result, speed_on_track, speed_traces,
                   plot_strategy, team_pace_ranking)
from wdc import wdc
